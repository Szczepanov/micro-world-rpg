<<<<<<< C:/Users/mdszc/Downloads/projekty/micro-world-rpg/scripts/inventory_ui.gd
extends Control
...
# ESC handling is centralised in player.gd's _unhandled_input() state stack.
# Do not add KEY_ESCAPE here to avoid double-consuming the event.
>>>>>>> C:/Users/mdszc/.windsurf/worktrees/micro-world-rpg/micro-world-rpg-699f16d7/scripts/inventory_ui.gd
