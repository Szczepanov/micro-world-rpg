<<<<<<< C:/Users/mdszc/Downloads/projekty/micro-world-rpg/scripts/harvestable_node.gd
...
func harvest_hit(player: Character):
...
func _play_hit_effect():
	...
	tween.tween_property(_visual_node, "scale", Vector3(1.2, 1.2, 1.2), 0.08)
	tween.tween_property(_visual_node, "scale", Vector3(1.0, 1.0, 1.0), 0.08)
>>>>>>> C:/Users/mdszc/.windsurf/worktrees/micro-world-rpg/micro-world-rpg-699f16d7/scripts/harvestable_node.gd
