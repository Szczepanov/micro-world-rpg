<<<<<<< C:/Users/mdszc/Downloads/projekty/micro-world-rpg/scripts/level.gd
extends Node3D
...
func _debug_damage_base_heart() -> void:
	...
	if heart_health:
		heart_health.request_damage(100.0)
		print("Debug: Dealt 100 damage to Base Heart (current HP: ", heart_health.current_health, ")")
>>>>>>> C:/Users/mdszc/.windsurf/worktrees/micro-world-rpg/micro-world-rpg-699f16d7/scripts/level.gd
