<<<<<<< C:/Users/mdszc/Downloads/projekty/micro-world-rpg/scripts/grid_manager.gd
extends Node
...
func destroy_grid_structure(grid_coords: Vector3i) -> void:
	...
	if multiplayer.is_server():
		structure_removed.emit(grid_coords)
>>>>>>> C:/Users/mdszc/.windsurf/worktrees/micro-world-rpg/micro-world-rpg-699f16d7/scripts/grid_manager.gd
